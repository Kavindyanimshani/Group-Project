import {
  Typography_default
} from "./chunk-S5ZOJVPM.js";
import "./chunk-H7TD6GYQ.js";
import {
  useTheme
} from "./chunk-27RZ27QQ.js";
import {
  NoSsr,
  Popper,
  useSlotProps
} from "./chunk-DLLTZ45N.js";
import {
  require_react_dom
} from "./chunk-WXSKVWTA.js";
import {
  shouldForwardProp
} from "./chunk-WG3KIMMJ.js";
import "./chunk-LXNM5EC6.js";
import {
  init_ownerWindow,
  init_useControlled,
...
var useAnimatedPath = (path2, skipAnimation2) => {
  ...
  const interpolator = React17.useMemo(() => previousPath ? string_default(previousPath, path2) : () => path2, [previousPath, path2]);
  const {
    value
  } = useSpring({
    from: {
...
function AnimatedArea(props) {
  ...
  return (0, import_jsx_runtime7.jsxs)(React21.Fragment, {
    children: [(0, import_jsx_runtime7.jsx)("clipPath", {
      id: clipId,
      children: (0, import_jsx_runtime7.jsx)(animated.rect, {
        x: 0,
        y: 0,
        width: animatedWidth,
        height: top + height + bottom
      })
    }), (0, import_jsx_runtime7.jsx)("g", {
      clipPath: `url(#${clipId})`,
      children: (0, import_jsx_runtime7.jsx)(AreaElementPath, _extends({}, other, {
        ownerState,
        d: path2
      }))
    })]
...
function AreaElement(props) {
  ...
  return (0, import_jsx_runtime8.jsx)(Area, _extends({}, other, areaProps));
}
...
var useAggregatedData = () => {
  const seriesData = React27.useContext(SeriesContext).line;
  const axisData = React27.useContext(CartesianContext);
...
function AreaPlot(props) {
  ...
  return (0, import_jsx_runtime12.jsx)("g", _extends({}, other, {
    children: completedData.map(({
      ...
      area,
      gradientUsed
    }) => !!area && (0, import_jsx_runtime12.jsx)(AreaElement, {
      id: seriesId,
      d,
      color: color2,
...
function AnimatedLine(props) {
  ...
  return (0, import_jsx_runtime13.jsxs)(React28.Fragment, {
    children: [(0, import_jsx_runtime13.jsx)("clipPath", {
      id: clipId,
      children: (0, import_jsx_runtime13.jsx)(animated.rect, {
        x: 0,
        y: 0,
        width: animatedWidth,
        height: top + height + bottom
      })
    }), (0, import_jsx_runtime13.jsx)("g", {
      clipPath: `url(#${clipId})`,
      children: (0, import_jsx_runtime13.jsx)(LineElementPath, _extends({}, other, {
        ownerState,
        d: path2
      }))
    })]
...
function LineElement(props) {
  ...
  return (0, import_jsx_runtime14.jsx)(Line, _extends({}, other, lineProps));
}
...
var useAggregatedData2 = () => {
  const seriesData = React30.useContext(SeriesContext).line;
  const axisData = React30.useContext(CartesianContext);
  if (seriesData === void 0) {
    return [];
  }
  const {
...
function LinePlot(props) {
  ...
  return (0, import_jsx_runtime15.jsx)("g", _extends({}, other, {
    children: completedData.map(({
      ...
      return (0, import_jsx_runtime15.jsx)(LineElement, {
        id: seriesId,
        d,
        color: color2,
        gradientId: gradientUsed && getGradientId(...gradientUsed),
...
var useAxisEvents = (disableAxisListener) => {
  ...
  const mousePosition = React31.useRef({
    x: -1,
    y: -1
  });
  React31.useEffect(() => {
...
var ChartsSurface = React32.forwardRef(function ChartsSurface2(props, ref) {
  const {
    children,
    width,
    height,
  ...
  return (0, import_jsx_runtime16.jsxs)(ChartChartsSurfaceStyles, _extends({
    width,
    height,
    viewBox: `${svgView.x} ${svgView.y} ${svgView.width} ${svgView.height}`,
    ref
  }, other, {
    children: [(0, import_jsx_runtime16.jsx)("title", {
      children: title
    }), (0, import_jsx_runtime16.jsx)("desc", {
      children: desc
    }), children]
  }));
});
...
function MarkElement(props) {
  ...
  return (0, import_jsx_runtime19.jsx)(MarkElementPath, _extends({}, other, {
    style: {
      ...
      return groupIds.map((seriesId) => {
        ...
        return (0, import_jsx_runtime20.jsx)("g", {
          ...
          children: xData == null ? void 0 : xData.map((x2, index2) => {
            ...
            return (0, import_jsx_runtime20.jsx)(Mark, _extends({
              id: seriesId,
              dataIndex: index2,
              shape: "circle",
...
function ChartsXAxis(inProps) {
  ...
  const _React$useContext = React40.useContext(CartesianContext), _ref = props.axisId ?? xAxisIds[0], {
    xAxis: {
      [_ref]: {
        scale: xScale,
        tickNumber,
  ...
  } = _React$useContext, settings = _objectWithoutPropertiesLoose(_React$useContext.xAxis[_ref], _excluded13);
...
function ChartsYAxis(inProps) {
  ...
  const _React$useContext = React41.useContext(CartesianContext), _ref = props.axisId ?? yAxisIds[0], {
    yAxis: {
      [_ref]: {
        scale: yScale,
        tickNumber
  ...
  } = _React$useContext, settings = _objectWithoutPropertiesLoose(_React$useContext.yAxis[_ref], _excluded14);
...
function ChartsItemTooltipContent(props) {
  ...
  const series = React45.useContext(SeriesContext)[itemData.type].series[itemData.seriesId];
  const {
    xAxis,
    yAxis,
    xAxisIds,
...
true ? ChartsItemTooltipContent.propTypes = {
  ...
  contentProps: import_prop_types19.default.shape({
    ...
    getColor: import_prop_types19.default.func,
    ...
    series: import_prop_types19.default.object,
...
function ChartsAxisTooltipContent(props) {
  ...
  const relevantSeries = React47.useMemo(() => {
    const rep = [];
  ...
  const relevantAxis = React47.useMemo(() => {
...
true ? ChartsAxisTooltipContent.propTypes = {
  ...
  // | To update them edit the TypeScript types and run "pnpm proptypes"  |
  // ----------------------------------------------------------------------
  axisData: import_prop_types21.default.shape({
    x: import_prop_types21.default.shape({
      index: import_prop_types21.default.number,
      value: import_prop_types21.default.oneOfType([import_prop_types21.default.instanceOf(Date), import_prop_types21.default.number, import_prop_types21.default.string]).isRequired
    }),
    y: import_prop_types21.default.shape({
      index: import_prop_types21.default.number,
      value: import_prop_types21.default.oneOfType([import_prop_types21.default.instanceOf(Date), import_prop_types21.default.number, import_prop_types21.default.string]).isRequired
    })
  }).isRequired,
  ...
  contentProps: import_prop_types21.default.shape({
    axis: import_prop_types21.default.object,
    axisData: import_prop_types21.default.shape({
      x: import_prop_types21.default.shape({
        index: import_prop_types21.default.number,
        value: import_prop_types21.default.oneOfType([import_prop_types21.default.instanceOf(Date), import_prop_types21.default.number, import_prop_types21.default.string]).isRequired
    ...
    axisValue: import_prop_types21.default.oneOfType([import_prop_types21.default.instanceOf(Date), import_prop_types21.default.number, import_prop_types21.default.string]),
    classes: import_prop_types21.default.object,
    dataIndex: import_prop_types21.default.number,
    series: import_prop_types21.default.arrayOf(import_prop_types21.default.object),
...
function DefaultChartsLegend(props) {
  ...
  const labelStyle = React49.useMemo(
  ...
  const padding = React49.useMemo(() => getStandardizedPadding(paddingProps), [paddingProps]);
  const getItemSpace = React49.useCallback((label, inStyle = {}) => {
  ...
  const [seriesWithPosition, legendWidth, legendHeight] = React49.useMemo(() => {
    let x2 = 0;
    let y2 = 0;
...
true ? DefaultChartsLegend.propTypes = {
  ...
  drawingArea: import_prop_types23.default.shape({
    bottom: import_prop_types23.default.number.isRequired,
    height: import_prop_types23.default.number.isRequired,
    left: import_prop_types23.default.number.isRequired,
    right: import_prop_types23.default.number.isRequired,
  ...
  seriesToDisplay: import_prop_types23.default.arrayOf(import_prop_types23.default.shape({
...
function LineHighlightElement(props) {
  ...
  return (0, import_jsx_runtime34.jsx)(HighlightElement, _extends({
    pointerEvents: "none",
    ownerState,
    className: classes.root,
    cx: 0,
  ...
  return (0, import_jsx_runtime35.jsx)("g", _extends({}, other, {
    children: stackingGroups.flatMap(({
      ...
      return groupIds.flatMap((seriesId) => {
        ...
        const colorGetter = getColor(series[seriesId], xAxis[xAxisKey], yAxis[yAxisKey]);
        return (0, import_jsx_runtime35.jsx)(Element, _extends({
          id: seriesId,
...
function ChartsOnAxisClickHandler(props) {
  ...
  const svgRef = React56.useContext(SvgContext);
  const series = React56.useContext(SeriesContext);
  const {
    axis
  ...
  const {
    ...
    yAxisIds,
    yAxis
  } = React56.useContext(CartesianContext);
  React56.useEffect(() => {
    const element = svgRef.current;
...
var LineChart = React60.forwardRef(function LineChart2(props, ref) {
  const {
    xAxis,
    yAxis,
    series,
  ...
  return (0, import_jsx_runtime41.jsxs)(ResponsiveChartContainer, {
    ...
    children: [onAxisClick && (0, import_jsx_runtime41.jsx)(ChartsOnAxisClickHandler, {
      ...
      slots,
      slotProps
    })), !loading && (0, import_jsx_runtime41.jsx)(ChartsTooltip, _extends({}, tooltip, {
      slots,
      slotProps
...
true ? LineChart.propTypes = {
  ...
  xAxis: import_prop_types31.default.arrayOf(import_prop_types31.default.shape({
    ...
    max: import_prop_types31.default.oneOfType([import_prop_types31.default.instanceOf(Date), import_prop_types31.default.number]),
    min: import_prop_types31.default.oneOfType([import_prop_types31.default.instanceOf(Date), import_prop_types31.default.number]),
    position: import_prop_types31.default.oneOf(["bottom", "left", "right", "top"]),
